...
public class RoundImageView extends ImageView {
    ...
    public RoundImageView(Context context, AttributeSet attrs) {
        ...
        roundBorderWidth = a.getDimensionPixelSize(R.styleable.RoundImageView_roundBorderWidth,3);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
    {
        ...
        if (type == TYPE_CIRCLE)
        {
            ...
            mWidth = Math.min(getMeasuredWidth()-dp2px(4), getMeasuredHeight()-dp2px(4));
            mRadius = mWidth / 2;
